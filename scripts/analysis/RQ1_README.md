...
- AmberChat-7B: `RCR = 0.773`
- OLMo-3-7B: `RCR = 0.889`
- RedPajama-7B: `RCR = 0.844`

Across RAS bins, correction rates were lower in the highest-support group than
in the lowest-support group by 8.0 percentage points for AmberChat-7B, 8.7 for
OLMo-3-7B, and 10.0 for RedPajama-7B.
